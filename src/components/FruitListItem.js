...
import { incrementQuantity, decrementQuantity } from "../actions/FruitActionCreators";
...
export default class FruitListItem extends Component {
	...
	render() {
		...
		return (
		    ...
		    <button className="minus" onClick={decrementQuantity.bind(null, this.props.id)}>-</button>
		    {this.props.fruit}
